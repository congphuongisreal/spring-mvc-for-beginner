...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>NPC <spring:message code="typeProduct"/></title>
    <meta name="viewport"
        ...
        <div class="app-main__outer">
            <div class="app-main__inner form_edit">
                <div class="modal-content">
                    <c:url value="/type/update" var="url"></c:url>
                                ...
                                <div class="form-row">
                                    <div class="col-lg-4">
                                        <div class="position-relative form-group">
                                            <label class="mr-sm-2" for="typeId"><spring:message
                                                    code="code"/></label>
                                            <form:input type="text" class="form-control"
                                                         readonly="true"
                                                        path="typeId"></form:input>
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="position-relative form-group">
                                            ...
                                            <form:input type="text"
                                                        placeholder="Name Type..." class="form-control" readonly="${readonly}"
