        ...
        <div class="app-main__outer">
            <div class="app-main__inner form_edit">
                <div class="modal-content">
                    <c:url value="/provider/update" var="url"></c:url>
                    <form:form method="POST" action="${url}" modelAttribute="providerObj">
                        <div class="modal-header">
                            <h5 class="modal-title"><spring:message code="provider"/></h5>
                        </div>
                                ...
                                <div class="form-row">
                                    <div class="col-lg-6">
                                        <div class="position-relative form-group">
                                            <label class="mr-sm-2" for="providerId">
                                                <spring:message code="code"/></label>
                                            <form:input type="text" class="form-control"
                                                        readonly="true" path="providerId"></form:input>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <form:input type="text"
                                                        placeholder="Name Provider..." class="form-control"
                                                        readonly="${readonly}"
                        ...
                        <div class="modal-footer">
                            <a href="<c:url value="/provider" />" type="button" class="btn btn-secondary">
