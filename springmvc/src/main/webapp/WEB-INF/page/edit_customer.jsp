        ...
        <div class="app-main__outer">
            <div class="app-main__inner form_edit">
                <div class="modal-content">
                    <c:url value="/customer/update" var="url"></c:url>
                    <form:form method="POST" action="${url}" commandName="customerObj">
                        <div class="modal-header">
                            <h5 class="modal-title"><spring:message code="customer"/></h5>
                        </div>
                                ...
                                <div class="form-row">
                                    <div class="col-lg-6">
                                        <div class="position-relative form-group">
                                            <label class="mr-sm-2" for="customerId">
                                                <spring:message code="code"/></label>
                                            <form:input type="text" class="form-control"
                                                        readonly="true" path="customerId"></form:input>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="position-relative form-group">
